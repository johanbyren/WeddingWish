    ...
    code: CodeProvider(
      CodeUI({
        ...
        sendCode: async (claims, code) => {
          ...
          console.log('Email sender: ', Resource.Email.sender);
          ...
          try {
              ...
              new SendEmailCommand({
                ...
                Content: {
                  Simple: {
                    ...
                    Body: {
                      Text: {
                        Data: `Here is your verification code to log in on Our Dream Day: ${code}`,
                      },
                    },
                  },
                },
            ...
            // Re-throw the error so OpenAuth knows the email failed
